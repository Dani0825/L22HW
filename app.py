...
# Load API key from Streamlit secrets (set in Streamlit Cloud → Settings → Secrets)
_api_key = st.secrets.get("COINGECKO_API_KEY", None)

# Include the Demo API key header if available — raises rate limit significantly
HEADERS = {
